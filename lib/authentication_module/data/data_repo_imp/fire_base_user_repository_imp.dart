...
class FireBaseUserRepositoryImp extends BaseFireBaseUserRepository {
  ...
  @override
  Future<void> signOutContract() async =>
      await baseFirebaseRemoteDataSource.signOutDataSource();
  ...
  String getCurrentUIdContract() =>
      baseFirebaseRemoteDataSource.getCurrentUIdDataSource();

  @override
  bool isSignInContract() => baseFirebaseRemoteDataSource.isSignInDataSource();

  @override
  Future<void> forgotPasswordContract(String email) async {
    await baseFirebaseRemoteDataSource.forgotPassword(email);
  }

  @override
  Future<void> googleSignInContract() async {
    await baseFirebaseRemoteDataSource.googleAuth();
  }
}
