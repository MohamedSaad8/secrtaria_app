...
import '../../authentication_module/presentation/widgets/custom_login_form.dart';
import '../../authentication_module/presentation/widgets/custom_register_form.dart';
...
//* *****************************************************************************
    ...
    //* Screens
    getIt.registerLazySingleton<CustomLoginForm>(() => CustomLoginForm());

    getIt.registerLazySingleton<CustomRegisterForm>(() => CustomRegisterForm());

    //*Cubits
    getIt.registerLazySingleton<AuthCubit>(() => AuthCubit(
        isSignInUseCase: getIt(),
        currentUIDUseCase: getIt(),
        signOutUseCase: getIt()));

    getIt.registerLazySingleton<CredentialCubit>(() => CredentialCubit(
        getCreateCurrentUserUseCase: getIt(),
    ...
    getIt.registerLazySingleton<GoogleSignInUseCase>(
        () => GoogleSignInUseCase(baseFireBaseUserRepository: getIt()));

    getIt.registerLazySingleton<ForgotPasswordUseCase>(
        () => ForgotPasswordUseCase(baseFireBaseUserRepository: getIt()));
